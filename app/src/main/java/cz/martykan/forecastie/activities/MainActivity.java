...
//        }
    ...
    private void updateTodayWeatherUI() {
        ...
        String rainString = UnitConvertor.getRainString(rain, todayWeather.getPercentOfPrecipitation(), sp);
    ...
    public ParseResult parseLongTermJson(String result) {
        ...
        try {
            ...
            for (i = 0; i < list.length(); i++) {
                ...
                weather.setPercentOfPrecipitation(listItem.optDouble("pop", 0));
